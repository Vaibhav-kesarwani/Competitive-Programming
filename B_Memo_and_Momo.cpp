 ...
 * Created       :         December 15, 2024 09:17:11
 * Workspace     :         ~/Desktop/Competitive-Programming
 * Problem name  :         B_Memo_and_Momo
*/
...
void Solve_Karo_Jaldi_Sa_Dusra_Bhi_Karna_Hai() {
    ...
    if (x % z == 0 && y % z == 0) cout << "Both" nt
    else if (x % z == 0 && y % z != 0) cout << "Memo" nt
    else if (y % z == 0 && x % z != 0) cout << "Momo" nt
    else cout << "No One" nt
}
