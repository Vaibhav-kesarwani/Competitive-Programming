 ...
 * Created       :         December 15, 2024 09:39:10
 * Workspace     :         ~/Desktop/Competitive-Programming
 * Problem name  :         H_Data_Type_Guessing
*/
...
void Solve_Karo_Jaldi_Sa_Dusra_Bhi_Karna_Hai() {
    ...
    if (myRes > 0) cout << "double" nt
    else if (myNumber <= 2147483647) cout << "int" nt
    else cout << "long long" nt
}
