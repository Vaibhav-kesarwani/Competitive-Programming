 ...
 * Created       :         December 15, 2024 10:08:29
 * Workspace     :         ~/Desktop/Competitive-Programming
 * Problem name  :         A_Arpa_s_hard_exam_and_Mehrdad_s_naive_cheat
 */
...
void Solve_Karo_Jaldi_Sa_Dusra_Bhi_Karna_Hai() {
    ...
    if (n % 4 == 0) cout << "6" nt
    else if (n % 4 == 1) cout << "8" nt
    else if (n % 4 == 2) cout << "4" nt
    else if (n % 4 == 3) cout << "2" nt
}
