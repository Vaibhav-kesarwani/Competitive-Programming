 ...
 * Created       :         December 08, 2024 09:47:50
 * Workspace     :         ~/Desktop/Competitive-Programming
 * Problem name  :         B_Card_Game
*/
...
void Solve_Karo_Jaldi_Sa_Dusra_Bhi_Karna_Hai() {
    cin >> a >> b >> c >> d;
    cnt = 0;
    if (help(a ,c) + help(b, d) > 0) cnt++;
    if (help(a, d) + help(b, c) > 0) cnt++;
    if (help(b, d) + help(a, c) > 0) cnt++;
    if (help(b, c) + help(a, d) > 0) cnt++;
