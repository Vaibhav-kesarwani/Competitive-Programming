 ...
 * Created       :         December 12, 2024 19:10:03
 * Workspace     :         ~/Desktop/Competitive-Programming
 * Problem name  :         H_Two_numbers
*/
...
void Solve_Karo_Jaldi_Sa_Dusra_Bhi_Karna_Hai() {
    ...
    cout << "floor " << x << " / " << y << " = " << floor(x / y) nt
    cout << "ceil " << x << " / " << y << " = " << ceil(x / y) nt
    cout << "round " << x << " / " << y << " = " << round(x / y) nt
}
