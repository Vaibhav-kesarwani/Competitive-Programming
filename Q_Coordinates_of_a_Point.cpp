 ...
 * Created       :         December 13, 2024 08:40:39
 * Workspace     :         ~/Desktop/Competitive-Programming
 * Problem name  :         Q_Coordinates_of_a_Point
*/
...
void Solve_Karo_Jaldi_Sa_Dusra_Bhi_Karna_Hai() {
    ...
    if (x == 0 && y == 0) cout << "Origem" nt
    else if (x == 0) cout << "Eixo Y" nt
    else if (y == 0) cout << "Eixo X" nt
    else if (x > 0 && y > 0) cout << "Q1" nt
    else if (x < 0 && y > 0) cout << "Q2" nt
    else if (x < 0 && y < 0) cout << "Q3" nt
    else cout << "Q4" nt
}
